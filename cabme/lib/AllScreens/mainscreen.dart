...
import 'package:cabme/AllScreens/HistoryScreen.dart';
import 'package:cabme/AllScreens/aboutScreen.dart';
import 'package:cabme/AllScreens/loginScreen.dart';
import 'package:cabme/AllScreens/profileTabPage.dart';
import 'package:cabme/AllScreens/ratingScreen.dart';
import 'package:cabme/AllScreens/registrationscreen.dart';
import 'package:cabme/AllScreens/searchScreen.dart';
import 'package:cabme/AllWidgets/CollectFareDialog.dart';
import 'package:cabme/AllWidgets/Divider.dart';
import 'package:cabme/AllWidgets/noDriverAvailableDialog.dart';
import 'package:cabme/AllWidgets/progressDialog.dart';
import 'package:cabme/Assistants/assistantMethods.dart';
import 'package:cabme/Assistants/geoFireAssistant.dart';
import 'package:cabme/DataHandler/appData.dart';
import 'package:cabme/Models/directionDetails.dart';
import 'package:cabme/Models/nearbyAvailableDrivers.dart';
import 'package:cabme/configMaps.dart';
...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin
{
  ...
  void locatePosition() async
  {
    ...
    //You will be stressed later because your code won't work maybe after 10 days and then you shall find me
    //I will be here because you already coded me in the past :p . See you soon lad
    //This address will work after billing information in google/geocoordiator chapter17
                  ...
                  child: Column(
                    children: [
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          displayToastMessage("searching CabMe-Go...", context);

                          setState(() {
                            state = "requesting";
                            carRideType = "cabme-go";
                          });
                          displayRequestRideContainer();
                          availableDrivers = GeoFireAssistant.nearByAvailableDriversList;
                          searchNearestDriver();
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                Image.asset("images/cabmego.png", height: 70.0, width: 80.0,),
                                SizedBox(width: 16.0,),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(
                                      "CabMe-Go", style: TextStyle(fontSize: 18.0, fontFamily: "Brand Bold",),
                                    ),
                                    Text(
                                      ((tripDirectionDetails != null) ? tripDirectionDetails.distanceText : '') , style: TextStyle(fontSize: 16.0, color: Colors.grey,),
                                    ),
                      ...
                      GestureDetector(
                        onTap: ()
                        {
                          displayToastMessage("searching CabMe-X...", context);
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: [
                                Image.asset("images/cabmex.png", height: 70.0, width: 80.0,),
                                SizedBox(width: 16.0,),
                                Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(
                                      "CabMe-X", style: TextStyle(fontSize: 18.0, fontFamily: "Brand Bold",),
                                    ),
                                    Text(
                                      ((tripDirectionDetails != null) ? tripDirectionDetails.distanceText : '') , style: TextStyle(fontSize: 16.0, color: Colors.grey,),
                                    ),
