        ...
        body: ListView(
          children: <Widget>[
            Container(
              height: 220,
              child: Center(
                child: Image.asset('images/cabmex.png'),
              ),
            ),
            Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  SizedBox(height: 30),
                  Text(
                      'This app has been developed by Yusuf Borkar - aka RakRob, '
                          'Co-founder of CabMe. This app offer cheap rides at cheap rates, '
