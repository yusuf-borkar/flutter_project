...
import 'package:cabme_drivers_app/Models/drivers.dart';
import 'package:cabme_drivers_app/Notifications/pushNotificationService.dart';
...
class _HomeTabPageState extends State<HomeTabPage> {
  ...
  void makeDriverOnlineNow() async
  {
    ...
    Geofire.setLocation(currentfirebaseUser.uid, currentPostion.latitude, currentPostion.longitude);
